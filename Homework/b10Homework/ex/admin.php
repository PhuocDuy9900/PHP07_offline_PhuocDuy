...
if ($_SESSION['flagPermission'] == true) {
    ...
    if (isset($_POST['submit-timeout'])) {
        $xml     = simplexml_load_file(DIR_DATA."timeout.xml");
        $xml->timeout = $_POST['submit-timeout'];
        $handle = fopen(DIR_DATA."timeout.xml","wb");
            ...
            <div class="content-wrap">
                <div class="container">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            <h4 class="mb-2">Timeout</h4>
                            <input class="sm-form-control" id="submit-timeout" name="submit-timeout" value="<?=$timeout?>"></input>
                        </div>
                        <?php
